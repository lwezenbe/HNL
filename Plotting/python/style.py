...
def getHNLfromTau(name):
    ...
    elif 'XG' in name or 'V#gamma' in name or 'DY' in name:          return TColor.GetColor("#ffcc66")
    elif 'TT-T+X' in name or 't(#bar{t})X' in name or 't#bar{t}' in name:         return TColor.GetColor("#6B717E") 
    elif 'Other' in name or 'W+jets' in name:          return TColor.GetColor("#77BFA3")
