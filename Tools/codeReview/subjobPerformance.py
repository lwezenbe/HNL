...
#
code_to_test = os.path.join(base_path, 'TMVA', 'prepareTrees.py --isTest --year 2016 --region highMassSR')
year = '2016'
sublist = 'TMVA/fulllist_'+year+'_nosignal_mconly'
skim = 'Reco'


# code_to_test = os.path.join(base_path, 'Analysis', 'calcYields.py --isTest --year 2016 --region lowMassSR')
# sublist = 'test'
# year = '2016'
# skim = 'Old'
...
out_file.write('SAMPLE \t \t #subjobs \t #events in subjob 0 \t tot events \t time for 1000 events \t extrapolated time \n' )
