...
out_file.write('SAMPLE \t \t #subjobs \t #events in subjob 0 \t tot events \t time for 400 events \t extrapolated time \n' )
for sample in sample_manager.sample_list:
    ...
    extrapolated_time = passed_time * n_events/(sample.split_jobs*400)
