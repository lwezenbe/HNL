...
#        'minMos':        (lambda c : c.minMos,   np.arange(0., 210., 10.),         ('min(M_{OS}) [GeV]', 'Events')),
        ...
        'm3l':          (lambda c : c.M3l,      np.arange(0., 95., 15.),         ('M_{3l} [GeV]', 'Events')),
...
#        'l2pt':      (lambda c : c.l_pt[1],       np.arange(0., 200., 10.),       ('p_{T} (l2) [GeV]', 'Events')),
        'l2pt':      (lambda c : c.l_pt[1],       np.arange(0., 65., 5.),       ('p_{T} (l2) [GeV]', 'Events')),
#        'l3pt':      (lambda c : c.l_pt[2],       np.arange(0., 150., 5.),       ('p_{T} (l3) [GeV]', 'Events')),
        'l3pt':      (lambda c : c.l_pt[2],       np.arange(0., 65., 5.),       ('p_{T} (l3) [GeV]', 'Events')),
...
#        #'j2pt':      (lambda c : c.j_pt[1],       np.arange(0., 300., 15.),       ('p_{T} (j2) [GeV]', 'Events')),
        ...
        'l1phi':      (lambda c : c.l_phi[0],       np.arange(-2.5, 4.0, 0.5),       ('#phi (l1)', 'Events')),
        'l2phi':      (lambda c : c.l_phi[1],       np.arange(-2.5, 4.0, 0.5),       ('#phi (l2)', 'Events')),
        'l3phi':      (lambda c : c.l_phi[2],       np.arange(-2.5, 4.0, 0.5),       ('#phi (l3)', 'Events')),
        'j1phi':      (lambda c : c.j_phi[0],       np.arange(-2.5, 4.0, 0.5),       ('#phi (j1)', 'Events')),
        'j2phi':      (lambda c : c.j_phi[1],       np.arange(-2.5, 4.0, 0.5),       ('#phi (j2)', 'Events')),
...
#        'mt3':   (lambda c : c.mt3,      np.arange(0., 415., 15.),         ('M_{T}(3l) [GeV]', 'Events')),
        'LT':   (lambda c : c.LT,      np.arange(0., 215., 15.),         ('L_{T} [GeV]', 'Events')),
#        'LT':   (lambda c : c.LT,      np.arange(0., 915., 15.),         ('L_{T} [GeV]', 'Events')),
#        #'HT':   (lambda c : c.HT,      np.arange(0., 915., 15.),         ('H_{T} [GeV]', 'Events')),
        'HT':   (lambda c : c.HT,      np.arange(0., 275., 15.),         ('H_{T} [GeV]', 'Events')),
