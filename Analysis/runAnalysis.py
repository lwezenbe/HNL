...
argParser.add_argument('year',     action='store',              help='Select year', choices=['2016', '2017', '2018'], required=True)
argParser.add_argument('yieldsOrKin',     action='store',              help='Plot kinematic variables or yields per signal region', choices=['yields', 'kinematics'], required=True)
...
argParser.add_argument('--region',   action='store', default='baseline',  help='apply the cuts of high or low mass regions, use "all" to run both simultaniously', choices=['baseline', 'highMassSR', 'lowMassSR', 'allSR', 'ZZ', 'WZ'])
