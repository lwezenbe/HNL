...
def drawPlot(hist_dict, output_name, x_label, x_name, extra_text, name):
...
#drawPlot(hist_dict, output_base+'/PostFitPlotsForPaper/fig8', ['La{0}'.format(x) for x in xrange(1, 9)]+['Lb{0}'.format(x) for x in xrange(1, 9)], 'Search region', extra_text, '8p1')
...
#drawPlot(hist_dict, output_base+'/PostFitPlotsForPaper/fig8', ['La{0}'.format(x) for x in xrange(1, 9)]+['Lb{0}'.format(x) for x in xrange(1, 9)], 'Search region', extra_text, '8p2')
#cleanUp(original_file)
#
##
## Figure 8.3
...
#drawPlot(hist_dict, output_base+'/PostFitPlotsForPaper/fig8', ['Ha{0}'.format(x) for x in xrange(1, 10)], 'Search region', extra_text, '8p3')
#cleanUp(original_file)
#
##
## Figure 8.4
...
#drawPlot(hist_dict, output_base+'/PostFitPlotsForPaper/fig8', ['Ha{0}'.format(x) for x in xrange(1, 10)], 'Search region', extra_text, '8p4')
#cleanUp(original_file)
#
##
## Figure 8.5
...
#
#extra_text = loadExtraText('0#tau_{h}', 'tau', 4e-1)
#drawPlot(hist_dict, output_base+'/PostFitPlotsForPaper/fig8', ['Hb{0}'.format(x) for x in xrange(1, 17)], 'Search region', extra_text, '8p5')
#cleanUp(original_file)
#
##
## Figure 8.6
...
#
#extra_text = loadExtraText('1#tau_{h}', 'tau', 4e-1)
#drawPlot(hist_dict, output_base+'/PostFitPlotsForPaper/fig8', ['Hb1', 'Hb2-3']+['Hb{0}'.format(x) for x in xrange(4, 17)], 'Search region', extra_text, '8p6')
#cleanUp(original_file)
